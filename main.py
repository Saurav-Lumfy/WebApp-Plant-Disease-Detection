...
def show_navigation():
    ...
    pages = ["Home", "Predictions", "Disease Suggestions", "Reviews", "About", "Account"]
...
def account_page():
    ...
    if st.session_state.user:
        ...
        with st.expander("🗑️ Account Deletion", expanded=False):
            st.markdown("""
            <style>
                .danger-zone { border-left: 5px solid #ff4b4b; padding: 10px; background: #000000; }
            </style>
...
def main():
    ...
    if st.session_state.page == 'Home':
        ...
        prediction_page()
    elif st.session_state.page == 'Disease Suggestions':
        disease_chatbot()
